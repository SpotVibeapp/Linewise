...
void main() {
  test('apiKey query values are redacted', () {
    final url =
        'https://api.the-odds-api.com/v4/sports/x/odds?apiKey=SECRET123&regions=us';
  ...
  test('bearer tokens and labeled secrets are redacted', () {
    expect(redactSecrets('Bearer abc.def-123'), 'Bearer <redacted>');
  ...
  test('error objects are scrubbed before logging', () {
    final err = Exception(
        'GET https://api.the-odds-api.com/v4/x?apiKey=TOPSECRET failed');
